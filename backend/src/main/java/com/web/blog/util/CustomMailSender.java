...
//
//	// MailHandler의 생성자
//	public CustomMailSender(JavaMailSender jSender) throws MessagingException {
//		this.sender = jSender;
...
//		messageHelper.setTo("tsopime@hanmail.net");
//	}
//
//	// 보낼때 제목
...
//	}
//
//	// addInline메서드는 간단한 첨부파일을 보내는데 쓰이는 것 같습니다.(저는 아직 사용 해보지 않았습니다.)
//	// https://docs.spring.io/spring/docs/3.0.0.M3/reference/html/ch26s03.html 에 가셔서
//	// 한번 보셔도 좋을 것 같습니다.
//	public void addInline(String contentId, Resource resource) throws MessagingException {
//		messageHelper.addInline(contentId, (DataSource) resource);
//	}
//
